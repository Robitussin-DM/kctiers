...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: KC.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: KCd.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeKCamount=<n> " + _("Keep N Kraken anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeKrakenAmount = GetArg("-anonymizeKCamount", 0);
