...
private slots:
    ...
    QString BuyKC(QString OrderType, double Quantity, double Rate);
    QString SellKC(QString OrderType, double Quantity, double Rate);
