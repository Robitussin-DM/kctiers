...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 2500) (2, 10000) (3, 20000) (4, 40000); 
static std::map<int, int> masternodeTiers157000 = map_list_of (1, 10000) (2, 20000) (3, 30000); 

// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 6) (2, 30) (3, 75) (4, 190); 
...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 1000 KC, signature to prove
